...
$jscomp.polyfill = function(b, h, f, q) {
    if (h) {
        ...
        q = f[b];
        h = h(q);
        h != q && null != h && $jscomp.defineProperty(f, b, {
            configurable: !0,
            writable: !0,
            value: h
        })
...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, f, q) {
        ...
        if ("function" == typeof l) {
            b = l.call(b);
            for (var r = 0; !(l = b.next()).done;) h.push(f.call(q, l.value, r++))
        } else
...
(function() {
    ...
    function r(a) {
        ...
        (function d() {
            ...
            1 < (e += .1) || (a.style.opacity = e, requestAnimationFrame(d))
        })()
    }
    ...
    function H(a) {
        ...
        a.querySelectorAll(".carousel-item").forEach(function(a) {
            for (var c = a, b = 1; b < d; b++) {
                ...
                if (e = c) {
                    var f = 0;
                    do f++; while (e = e.previousElementSibling);
                    e = f
                } else e = -1;
    ...
    function I(a) {
        ...
        if (d) {
            ...
            for (var e = 0; e < d.length; e++) c.push('"' + d[e].getAttribute("stop-color") + '"');
            c = '"lineargradient": [' + c + "],";
    ...
    function E() {
        if (document.querySelector(".loop-container")) {
            var a = function(c) {
                var d = 0,
                    b = 0,
                    m = +c.children[0].dataset.speed || .05,
    ...
    var g, n, u = "function" == typeof jQuery;
    u && (g = jQuery);
    g ? n = g("html").hasClass("is-builder") :
        n = document.querySelector("html").classList.contains("is-builder");
    Element.prototype.parents = function(a) {
        for (var c = [], b = this, e = void 0 !== a; null !== (b = b.parentElement);) b.nodeType === Node.ELEMENT_NODE && (e && !b.matches(a) || c.push(b));
        return c
    };
    Element.prototype.footerReveal = function() {
        function a() {
            !e && c.offsetHeight <= window.outerHeight ? (c.style.zIndex = "-999", c.style.position = "fixed", c.style.bottom = "0", c.style.width = b.offsetWidth + "px", b.style.marginBottom = c.offsetHeight + "px") : (c.style.zIndex = "", c.style.position =
    ...
    var K = function() {
        ...
        var b = parseInt(window.innerHeight / 2, 10),
            e = parseInt((window.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle).height, 10);
        c.removeChild(a);
        return e == b
    }();
    k(function() {
            ...
            b(a, "[data-bg-video]").forEach(function(a) {
                ...
                if (c) {
                    var b = new URLSearchParams(c),
                        ...
                        m = c.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(shorts\/|video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/),
                    ...
                    if (m && (/youtu\.?be/g.test(m[3]) || /vimeo/g.test(m[3])))
                        if (m && /youtu\.?be/g.test(m[3])) {
                            ...
                            t.onload = function() {
                                ...
                                } else e.style.backgroundImage = 'url("' + t.src + '")', e.style.display = "block";
                        ...
                        } else m && /vimeo/g.test(m[3]) && (b = new XMLHttpRequest,
                            b.open("GET", "https://vimeo.com/api/v2/video/" + m[6] + ".json", !0), b.onreadystatechange = function() {
                    ...
                    else if (n) e.style.backgroundImage = 'url("images/video-placeholder.jpg")', e.style.display =
                        "block";
                    else if (!n) {
            ...
            if (n) {
                ...
                g(document).on("changeParameter.cards", function(a, b, d, e) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", g(a.target).find(".mbr-background-video-preview").remove(),
                        g(a.target).find(".mbr-background-video").remove(), e) {
                        case "type":
        ...
        window.addEventListener("scroll", function() {
            ...
            if (p) {
                ...
                b ? c != p.fixed && (l ? (p.fixed = c, p.elm.classList.toggle("is-fixed")) : m = setTimeout(function() {
                    p.fixed = c;
        ...
        if (n) g(document).on("changeParameter.cards", function(a, b, c, e) {
            if ("bg" === b) switch (e) {
                case "type":
    ...
    if (!n) {
        ...
        k(function() {
            if (!x() && document.querySelectorAll("input[name=animation]").length) {
                var a = function() {
                        ...
                        e.forEach(function(e) {
                            var m = e.offsetHeight,
                                f = d(e);
                            (f + m >= a && f - 50 <= c || b(e)) && e.classList.contains("hidden") && (e.classList.remove("hidden"), e.classList.add("animate__fadeInUp"), e.classList.add("animate__delay-1s"), e.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
                                function() {
                ...
                var e = Array.from(document.querySelectorAll("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info"));
        ...
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            ...
            window.addEventListener("scroll", function() {
                (document.documentElement.scrollTop || document.body.scrollTop) > Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight,
                    document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight) / 2 - document.documentElement.clientHeight / 2 || window.scrollY > window.innerHeight ? r(a) : l(a)
            });
    ...
    document.querySelectorAll("nav.navbar").length && (v = f(document.querySelector("nav.navbar")), document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = v + "px"));
            ...
            var a = function(a) {
                ...
                b = function(b) {
                    ...
                    k.addEventListener("click", function(b) {
                        "VIDEO" !== b.target.tagName && (d ? (-1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== d.indexOf("vimeo") && f.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(), k.style.display = "none", k.removeEventListener("click", a), h.style.zIndex = "0")
                    })
                };
    ...
    if (n && u) g(document).on("add.cards", function(a) {
    ...
    if (n) g(document).on("add.cards", F);
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/html-builder.html">HTML Website Creator</a> Mobirise v6.1.12 <a href="https://mobirise.com/offline-website-builder.html">Offline Website Software</a>';
